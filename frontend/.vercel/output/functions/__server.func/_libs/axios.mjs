import { F as FormData$1 } from "./form-data.mjs";
import require$$1 from "crypto";
import require$$2 from "url";
import { g as getProxyForUrl } from "./proxy-from-env.mjs";
import { H as HttpsProxyAgent } from "./https-proxy-agent.mjs";
import require$$3 from "http";
import require$$2$1 from "https";
import http2 from "http2";
import require$$1$1 from "util";
import { resolve } from "path";
import { f as followRedirects } from "./follow-redirects.mjs";
...
const URLSearchParams = require$$2.URLSearchParams;
  ...
  return wrapAsync(async function dispatchHttpRequest(resolve$1, reject, onDone) {
    ...
    if (isHttp2) {
      ...
      if (configTransport) {
        ...
        transport = isHttpsRequest ? require$$2$1 : require$$3;
